...
public AddEmp(){
	...
	l3 = new JLabel("Add Employees Screen");
...
public void addemp(){
	...
	try{
		...
		String msg = DBCon.addEmp(input);
		if(user.equals("success")){
			JOptionPane.showMessageDialog(this,"Employee details added");
			setVisible(false);
		}else{
			JOptionPane.showMessageDialog(this,"Error in adding employee details");
		}
	}catch(Exception e){
		e.printStackTrace();
	}
